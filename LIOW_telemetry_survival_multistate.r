...
## SWITCHED TO MULTISTATE MODEL ON 23 Nov 2023 to include infor on birds recovered dead
...
sink("models/LIOW_CJS_multistate.jags")
cat("
...
# DIC2.D1M1=DIC.calc(INPUT, modelfit$mcmc, DevCalc2beta)
# PrintDIC(DIC2.D1M1, "Data 1, Model 1")
>>>>>>> main:LIOW_telemetry_survival.r

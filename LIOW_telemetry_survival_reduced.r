...
# ggsave("output/Fig_S1_parameter_estimates.jpg", height=11, width=8)

MCMCplot(seasonfeed.model$mcmc, params=c("mean.phi","beta.mass","beta.feed"))
# ggsave("output/Fig_S2_parameter_estimates.jpg", height=11, width=8)

MCMCplot(seasonweight.model$mcmc, params=c("mean.phi","beta.mass","beta.feed"))
# ggsave("output/Fig_S3_parameter_estimates.jpg", height=11, width=8)
...
# ggsave("output/Fig_1.jpg", height=7, width=11)
